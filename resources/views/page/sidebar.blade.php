...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/tableau_de_bord') }}" style="color: #6c380b;">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#projet-nav" data-bs-toggle="collapse" href="#" style="color: #6c380b;">
        ...
        <li class="nav-item">
            <a class="nav-link" href="" style="color: #6c380b;">
       ...
       @if(app('permission')->hasModule('api') && app('permission')->hasPermission('api', 'apikey'))
            <li class="nav-item">
                <a class="nav-link" href="{{ route('parametre.index') }}" 
                    style="color: #6c380b; font-weight: 500;">
