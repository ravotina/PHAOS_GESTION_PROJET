                        ...
                        <div class="row">
                            <div class="col-md-8 mx-auto">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="{{ route('administration.liste_a_faire') }}" class="btn btn-secondary btn-sm">
                                                <i class="bi bi-arrow-left"></i> Liste des tâches à faire
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('administration.workflowdemarrage') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                                        ...
                                                        name="description" 
                                                        rows="4"
                                                        placeholder="Décrivez la tâche (optionnel)">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                                ...
                                                <select class="form-control @error('id_type_projet') is-invalid @enderror" 
                                                    ...
                                                    @foreach($typeProjets as $typeProjet)
                                                        <option value="{{ $typeProjet->id_projet }}" 
                                                                {{ old('id_type_projet') == $typeProjet->id_projet ? 'selected' : '' }}>
                                                            {{ $typeProjet->nom }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <!-- Boutons -->
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="{{ route('a_faire.index') }}" class="btn btn-secondary">
