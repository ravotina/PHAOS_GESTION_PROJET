            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        ...
                        Ajouter un détail - {{ $lancement->nom }}
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('lancement.details.store', [$projet->id, $lancement->id]) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Formats: PDF, Word, Excel, Images (max: 2MB)</div>
                        </div>
                        
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('lancement.details.index', [$projet->id, $lancement->id]) }}" 
